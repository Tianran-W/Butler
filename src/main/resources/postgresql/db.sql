...
-- 为tb_battery表插入20条电池数据（覆盖多种状态和型号）
INSERT INTO tb_battery (model_name, sn_code, status, lifespan_cycles, current_cycles) VALUES
-- 高循环次数电池（接近寿命终点）
('LiPo-2200mAh-3S', 'BAT-3S-001', '可用', 500, 482),
('LiPo-2200mAh-3S', 'BAT-3S-002', '可用', 500, 435),
('LiPo-2200mAh-3S', 'BAT-3S-003', '待维修', 500, 517),
('LiPo-2200mAh-3S', 'BAT-3S-004', '报废', 500, 625),

-- 大容量主力电池（用于步兵机器人）
('LiPo-5000mAh-6S', 'BAT-6S-011', '可用', 300, 98),
('LiPo-5000mAh-6S', 'BAT-6S-012', '充电中', 300, 143),
('LiPo-5000mAh-6S', 'BAT-6S-013', '可用', 300, 67),
('LiPo-5000mAh-6S', 'BAT-6S-014', '待检测', 300, 256),
('LiPo-5000mAh-6S', 'BAT-6S-015', '损坏', 300, 312),

-- 高放电率电池（用于哨兵机器人）
('LiPo-1300mAh-4S-100C', 'BAT-HC-021', '可用', 400, 78),
('LiPo-1300mAh-4S-100C', 'BAT-HC-022', '充电中', 400, 326),
('LiPo-1300mAh-4S-100C', 'BAT-HC-023', '可用', 400, 112),

-- 特殊类型电池（铁锂电池）
('LiFe-3000mAh-4S', 'BAT-LIFE-031', '可用', 1000, 342),
('LiFe-3000mAh-4S', 'BAT-LIFE-032', '待维修', 1000, 872),

-- 小型电池（用于传感器模块）
('LiPo-1800mAh-2S', 'BAT-2S-041', '可用', 600, 121),
('LiPo-1800mAh-2S', 'BAT-2S-042', '可用', 600, 205),

-- 未标定新电池
('LiPo-6000mAh-6S', 'BAT-6S-051', '待标定', NULL, 0),
('LiPo-6000mAh-6S', 'BAT-6S-052', '库存', 400, 0),
('LiPo-6000mAh-6S', 'BAT-6S-053', '库存', 400, 0),

-- 异常状态电池
('LiPo-4000mAh-4S', 'BAT-4S-061', '过放损坏', 350, 189);